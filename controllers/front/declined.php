...
class TraxxDeclinedModuleFrontController extends ModuleFrontController 
{
	/**
	...
	{		
		...
		if ( strcasecmp($_POST['auth_hash'],$hash_check)!=0 ) {
			...
			$this->module->validateOrder($_POST['cart_id'], Configuration::get('PS_OS_TRAXX_DECLINED'), $_POST['tran_amount'], $this->module->displayName, NULL, false, (int)$this->context->currency->id, false, $_POST['xtra_secure_key']);
		}
	}
